  ...
  $('#menu-secundario a').click(function() {
    ...
    if ( mychildren.length > 0 ){
      ...
      if (mysrc.search('cerrado_p') != -1 ) {
        myarrow.replaceWith( '<img src="/media/img/ico_abierto_p.png" width="12" height="7" alt="menú abierto" />' );
        //myarrow.replaceWith( '<img src="i/ico_abierto_p.png" width="12" height="7" alt="menú abierto" />' );
        return false;
      } else if (mysrc.search('abierto_p') != -1 ) {
        myarrow.replaceWith( '<img src="/media/img/ico_cerrado_p.png" width="7" height="12" alt="menú cerrado" />' );
