$(document).ready(function(){
  ...
  $('.cap-nivel3').append( '<img src="/media/img/ico_abierto_p.png" width="12" height="7" alt="menú abierto" class="ujier-arrow" />' );  
  ...
  $('#region-contenido #contenido-ujier .cap-nivel3').click(function() {
    ...
    if (mysrc.search('cerrado_p') != -1 ) {
      ...
      myarrow.replaceWith( '<img src="/media/img/ico_abierto_p.png" width="12" height="7" alt="menú abierto" class="ujier-arrow" />' );
      return false;
      ...
      myarrow.replaceWith( '<img src="/media/img/ico_cerrado_p.png" width="7" height="12" alt="menú cerrado" class="ujier-arrow" />' );
      return false;
    }
  });
  ...
  $('#region-contenido #contenido-ujier #botones-colapsar-ujier .boton-cerrar').click(function() {
    ...
    $('#region-contenido #contenido-ujier .cap-nivel3 .ujier-arrow').replaceWith( '<img src="/media/img/ico_cerrado_p.png" width="7" height="12" alt="menú cerrado" class="ujier-arrow" />' );
    return false;
  });
  ...
  $('#region-contenido #contenido-ujier #botones-colapsar-ujier .boton-abrir').click(function() {
    ...
    $('#region-contenido #contenido-ujier .cap-nivel3 .ujier-arrow').replaceWith( '<img src="/media/img/ico_abierto_p.png" width="12" height="7" alt="menú abierto" class="ujier-arrow" />' );
    return false;
  });
